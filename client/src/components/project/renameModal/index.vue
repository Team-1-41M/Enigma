...
import { useRenameModalStore } from './renameModalStore';

const store = useProjectStore() //
const modalStore = useRenameModalStore();

const handleConfirmation = async () => {
  await store.renameProject(modalStore.selectedProject!.id, modalStore.newTitle);
